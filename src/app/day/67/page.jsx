  ...
  return (
    <>
        ...
        <div className='flex flex-row py-16 max-xl:h-fit max-xl:flex-wrap max-xl:py-4'>
          <div className='stats-radar basis-1/3 max-xl:basis-full'>
            ...
            <AnimatedNumber
              ...
              className='font-mono w-full text-[#a50044] justify-center'
            />
          </div>
          <div className='stats-radar basis-1/3 max-xl:basis-full'>
      ...
      <section id='score-recap' className='mt-[40px] mb-[20px]'>
        ...
        <div className='flex h-[2000px] flex-row py-16 max-md:hidden'>
          <NivoSankey
            ...
            nodes={sankeyNodes}
            colors={[
              ...new Array(17).fill('#FBBA00'),
              ...new Array(3).fill('#a50044'),
              ...new Array(1).fill('#004d98'),
              ...new Array(1).fill('#edbb00'),
            ]}
          />
        </div>
      </section>
      <p className='text-center text-xs'>
        ...
        <a
          className='text-[#004d98] font-bold'
          href='https://fbref.com/en/players/c1b4188c/intl_cup/Xavi-International-Cup-Stats'
      ...
      <div className='text-[#004d98] hover:bg-[#e1e1e0]'></div>
    </>
  );
};
