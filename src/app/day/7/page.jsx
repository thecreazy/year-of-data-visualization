    ...
    <>
        ...
        <div className='flex flex-row py-16 max-xl:h-fit max-xl:flex-wrap max-xl:py-4'>
          <div className='stats-radar basis-1/3 max-xl:basis-full'>
            ...
            <AnimatedNumber
              ...
              className='font-mono w-full text-[#DA291C] justify-center'
            />
          </div>
          <div className='stats-radar basis-1/3 max-xl:basis-full'>
      ...
      <section id='score-recap' className='mt-[40px] mb-[20px]'>
        ...
        <div className='flex h-[2000px] flex-row py-16 max-md:hidden'>
          <NivoSankey
            ...
            nodes={sankeyNodes}
            colors={[
              ...new Array(22).fill('#046A38'),
              ...new Array(3).fill('#DA291C'),
              ...new Array(5).fill('#002D72'),
              ...new Array(5).fill('#046A38'),
            ]}
          />
        </div>
      </section>
      <p className='text-center text-xs'>
        ...
        <a
          ...
          href='https://fbref.com/en/players/dea698d9/Cristiano-Ronaldo'
