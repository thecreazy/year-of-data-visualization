    ...
    <>
        ...
        <div className='flex flex-row py-16 max-xl:h-fit max-xl:flex-wrap max-xl:py-4'>
          <div className='stats-radar basis-1/3 max-xl:basis-full'>
            ...
            <AnimatedNumber
              ...
              className='font-mono w-full text-[#43a1d5] justify-center'
            />
          </div>
          <div className='stats-radar basis-1/3 max-xl:basis-full'>
      ...
      <section id='score-recap' className='mt-[40px] mb-[20px]'>
        ...
        <div className='flex h-[2000px] flex-row py-16 max-md:hidden'>
          <NivoSankey
            ...
            nodes={sankeyNodes}
            colors={[
              ...new Array(20).fill('#43a1d5'),
              ...new Array(3).fill('#173e69'),
              ...new Array(3).fill('#d5b048'),
              ...new Array(5).fill('#43a1d5'),
            ]}
          />
        </div>
      </section>
      <p className='text-center text-xs'>
        ...
        <a
          ...
          href='https://fbref.com/en/players/d70ce98e/all_comps/Lionel-Messi-Stats---All-Competitions'
      ...
      <div className='text-[#d5b048] hover:bg-[#e1e1e0]'></div>
    </>
  );
};
