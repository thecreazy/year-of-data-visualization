    ...
    <>
        ...
        <div className='flex flex-row flex-wrap max-md:h-fit max-md:py-4 justify-center'>
          <div className='stats-radar basis-1/2 max-md:basis-full h-[400px]'>
            <p className='text-center font-bold mb-4'>
              Male industrial employed percentage
            </p>
            <NivoChoropleth
              data={maleMapData}
              colors={[
          ...
          <div className='stats-radar basis-1/2 max-md:basis-full max-md:pt-20 h-[400px]'>
            <p className='text-center font-bold mb-4'>
              Female industrial employed percentage
            </p>
            <NivoChoropleth
              data={femaleMapData}
              colors={[
      ...
      <section id='year-distrubution' className='mt-10 pt-5'>
        ...
        <div className='flex flex-row flex-wrap max-md:h-fit max-md:py-4 justify-center'>
          <div className='stats-radar basis-1/2 max-md:basis-full h-[400px]'>
            <p className='text-center font-bold mb-4'>
              Male industrial employed percentage distrubution
            </p>
            <NivoBar
          ...
          <div className='stats-radar basis-1/2 max-md:basis-full max-md:pt-20 h-[400px]'>
            <p className='text-center font-bold mb-4'>
              Female industrial employed percentage distrubution
            </p>
            <NivoBar
      ...
      <section id='ratio--per-country' className='mt-20'>
        <h3 className='py-2 font-mono text-3xl max-md:text-2xl text-center flex max-md:flex-col justify-center items-center'>
          Difference into every country for male and female industrial employed
          percentage
        </h3>
      ...
      <p className='text-center text-xs mt-20'>
        ...
        <a
          ...
          href='https://gender-data-hub-2-undesa.hub.arcgis.com/datasets/00aebeebd9f6450db214b915eadd4740/explore'
