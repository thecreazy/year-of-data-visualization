...
const teams = [
  { name: 'Buffalo Braves', id: 'BUF', color: '#418FDE' },
  { name: 'Houston Rockets', id: 'HOU', color: '#BA0C2F' },
  { name: 'Philadelphia 76ers', id: 'PHI', color: '#D50032' },
  { name: 'Washington Bullets', id: 'WAS', color: '#002F6C' },
  { name: 'Atlanta Hawks', id: 'ATL', color: '#C8102E' },
  { name: 'Milwaukee Bucks', id: 'MIL', color: '#2C5234' },
  { name: 'San Antonio Spurs', id: 'SAS', color: '#8D9093' },
];
